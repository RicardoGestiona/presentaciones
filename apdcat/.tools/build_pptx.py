"""
build_pptx.py — PPTX 100 % nativo, fiel al render HTML de apdcat/index.html.

Walker DOM extrae cada elemento visible como átomo (shape o texto) con
posición, estilo y formato calculado por el navegador. python-pptx los
reconstruye uno a uno → cada elemento es seleccionable y editable.

Los elementos .phase (revelado progresivo en HTML) se capturan siempre en
su estado "visible": el PPTX resultante muestra cada slide con todo su
contenido ya desplegado (decisión: estático y 100% editable, sin animación
nativa de clic, para evitar riesgo de corrupción sin PowerPoint/LibreOffice
disponibles para validar el XML de <p:timing>).

Adaptado de certificacion-inap/.tools/build_pptx_perfect.py.
"""
...
# ─── JS: revelar todas las fases antes de extraer ─────────────────────────
JS_REVEAL_PHASES = r"""
() => {
